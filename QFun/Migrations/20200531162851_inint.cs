        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contribution_Challenge_ChallengeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vote", x => new { x.UserId, x.ContributionId });
                    table.ForeignKey(
                        name: "FK_Vote_Contribution_ContributionId",
            ...
            migrationBuilder.InsertData(
                table: "Contribution",
                columns: new[] { "Id", "ChallengeId", "Description", "Path", "TimeOfUpload", "UserId", "UserName" },
                values: new object[] { 1, 1, "i did this", "image here", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contribution_ChallengeId",
                table: "Contribution",
                column: "ChallengeId");
